...
const ETF_NAV_CODES = [
  '00400A', '00401A', '00403A', '00980A', '00981A', '00982A', '00983A',
  '00984A', '00985A', '00986A', '00987A', '00988A', '00989A', '00990A',
  '00991A', '00992A', '00993A', '00994A', '00995A', '00996A', '00997A',
  '00998A', '00999A',
];
    ...
    <main className={showChangeInfo ? "etf-v11-detail modal-open" : "etf-v11-detail"}>
      ...
      <style>{`
        ...
        */
        ...
        /* =========================================================
           V48: 真正用「同一個 grid parent」排表頭與資料列。
           v47 以前是 head/row 各自一個 grid，iPhone Safari 會因字重、sticky、捲動條造成肉眼錯位。
           這版把 head、body、row 攤平成 contents，所有 cell 直接吃同一組 grid columns。
        ========================================================= */
        @media (max-width: 768px){
          ...
          /* 成分股：header cell 與 body cell 共用同一個父 grid，避免錯位 */
          .etf-v42-holding-grid{
            --h-col-1:24%;
            --h-col-2:29%;
            --h-col-3:18%;
            --h-col-4:29%;
            display:grid !important;
            grid-template-columns:var(--h-col-1) var(--h-col-2) var(--h-col-3) var(--h-col-4) !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
            margin:0 !important;
          ...
          .etf-v42-holding-head .sort-arrows{
            flex:0 0 auto !important;
          }

          /* 操作日報：同樣用 parent grid 對齊表頭與資料列 */
          .etf-v41-op-grid{
            --o-col-1:22%;
            --o-col-2:16%;
            --o-col-3:23%;
            ...
            --o-col-5:22%;
            display:grid !important;
            grid-template-columns:var(--o-col-1) var(--o-col-2) var(--o-col-3) var(--o-col-4) var(--o-col-5) !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
            margin:0 !important;
          ...
          .etf-v11-detail.modal-open .etf-v41-op-head > div,
          .etf-v11-detail.modal-open .etf-v42-holding-head > div{
            opacity:0 !important;
            visibility:hidden !important;
            pointer-events:none !important;
            z-index:1 !important;
        ...
        /* =========================================================
           V50: 成分股 mobile compact table
           目標：學習 app 參考圖，手機版一頁看完，欄距收窄、字級降低、表頭與資料列重新用同一組 row grid。
           注意：這段放在最後，覆蓋 v42-v48 所有舊設定。
        ========================================================= */
        @media (max-width: 768px){
          .etf-v11-detail{
            width:100% !important;
          ...
          /* 表格：改回每一列自己是 grid，避免 display:contents 在 iPhone 上造成視覺錯位。 */
          .etf-v42-holding-grid{
            --v50-holding-cols:27% 25% 18% 30%;
            display:block !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
          ...
          .etf-v42-holding-row{
            display:grid !important;
            grid-template-columns:var(--v50-holding-cols) !important;
            column-gap:0 !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
          ...
          .etf-v42-holding-head{
            position:sticky !important;
            top:var(--etf-v50-sticky-top) !important;
          ...
          .etf-v42-holding-price small.red,
          .etf-v42-holding-price small.pos{ color:#e05258 !important; }
          .etf-v42-holding-price small.green,
          .etf-v42-holding-price small.neg{ color:#35a985 !important; }
        ...
        /* =========================================================
           V51: holding/operation table typography + spacing tune
           目標：更接近參考 app：字體不要過粗、列高更緊湊、欄位視覺距離縮小。
           這段放在 style 最後，覆蓋 V50。
        ========================================================= */
        @media (max-width: 768px){
          .etf-v11-detail{
          ...
          /* 成分股表格：所有欄位固定在手機寬度內，不做水平滑動 */
          .etf-v42-holding-grid{
            --v50-holding-cols:27% 25% 18% 30% !important;
            --v51-row-h:44px;
            overflow:hidden !important;
          ...
          .etf-v42-holding-row{
            height:var(--v51-row-h) !important;
            min-height:var(--v51-row-h) !important;
          }
          ...
          .etf-v42-holding-head > div:first-child{ padding-left:6px !important; }
          .etf-v42-holding-head > div:nth-child(2){ padding-right:4px !important; }
          .etf-v42-holding-head > div:nth-child(4){ padding-right:6px !important; }
          ...
          .etf-v42-holding-target{ padding-left:6px !important; padding-right:1px !important; }
          .etf-v42-holding-value{ padding-left:1px !important; padding-right:4px !important; }
          .etf-v42-holding-price{ padding-left:1px !important; padding-right:6px !important; }
          ...
          /* 操作日報表格也同步調整成同一種視覺密度 */
          .etf-v41-op-grid{
            --o-col-1:22% !important;
            --o-col-2:15% !important;
            --o-col-3:22% !important;
            --o-col-4:18% !important;
            --o-col-5:23% !important;
            overflow:hidden !important;
          }
          ...
          .etf-v41-op-target{ padding-left:6px !important; }
          .etf-v41-op-weight{ padding-right:6px !important; }
        ...
        @media (max-width: 390px){
          .etf-v42-holding-grid{
            --v50-holding-cols:28% 24% 18% 30% !important;
          }
        ...
        /* =========================================================
           V52: reference-app compact table final override
           目標：學習參考圖 3/4，不再用大字重與大欄距。
           做法：
           1. 禁止 iOS 文字自動放大。
           2. 成分股表格與操作日報表格改成較窄第一欄、較平均的中間欄。
           3. 數字不要全部推到欄位最右邊，改成接近參考 app 的中間視覺對齊。
           4. row 高度、padding、字重全部再壓低。
        ========================================================= */
        @media (max-width: 768px){
          html, body, .etf-v11-detail{
          ...
          .etf-v42-distribution-card{
            ...
            border:0 !important;
            border-top:1px solid #eef1f4 !important;
            border-bottom:7px solid #f4f5f7 !important;
            border-radius:0 !important;
            box-shadow:none !important;
          }
          ...
          .etf-v42-legend > div{
            grid-template-columns:7px minmax(0,1fr) 48px !important;
          ...
          /* ---------- 成分股表格：四欄不橫滑；欄距壓縮 ---------- */
          .etf-v42-holding-grid{
            --v52-holding-cols:23% 27% 20% 30% !important;
            display:block !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
          ...
          .etf-v42-holding-row{
            display:grid !important;
            grid-template-columns:var(--v52-holding-cols) !important;
          ...
          .etf-v42-holding-price small.red,
          .etf-v42-holding-price small.pos{ color:#d94f55 !important; }
          .etf-v42-holding-price small.green,
          .etf-v42-holding-price small.neg{ color:#2fa681 !important; }

          /* ---------- 操作日報表格同步變緊湊 ---------- */
          .etf-v41-op-grid{
            --v52-op-cols:21% 15% 22% 18% 24% !important;
            display:block !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
          ...
          .etf-v41-op-row{
            display:grid !important;
            grid-template-columns:var(--v52-op-cols) !important;
            column-gap:0 !important;
            width:100% !important;
            max-width:100% !important;
            min-width:0 !important;
        ...
        @media (max-width:390px){
          .etf-v42-holding-grid{ --v52-holding-cols:23% 27% 20% 30% !important; }
          .etf-v41-op-grid{ --v52-op-cols:21% 15% 22% 18% 24% !important; }
